...
Start a server from scratch ,handle every everything URL request ,GET request, POST request, manage data , clean , analyse it without google forms. #degoogled<br>.
...
Browser made using PySide2 , Chromium 92.x<br>
<div align="center">
